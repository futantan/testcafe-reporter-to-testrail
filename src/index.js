            ...
            api.getProjects(function (err, response, project) {
                if (err !== 'null' && typeof project !== 'undefined') {
                    ...
                    project.forEach(function (project) {
                        if (project.name === String(_this4.ProjectName)) {
                            _this4.ProjectID = project.id;
                            _this4.newline().write(_this4.chalk.blue.bold('Project name(id) ')).write(_this4.chalk.yellow(_this4.ProjectName + '(' + project.id + ')'));
                        }
                    });
                } else {
